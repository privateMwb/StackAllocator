...
// clang-format off
#include <StackPro/Stack.h>       // core type under test — not directly used by this tool's own
#include <StackPro/StackScope.h>  // code today; keep only if the main file needs it, otherwise drop
