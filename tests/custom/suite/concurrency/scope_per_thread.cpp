...
static void stacks_no_cross_see() {
...
static void rollback_per_thread() {
    constexpr int kThreads = 4;
...
static void many_stacks_match_serial() {
...
static void run_tests() {
    RUN(stacks_no_cross_see);
    RUN(rollback_per_thread);
    RUN(many_stacks_match_serial);
}
