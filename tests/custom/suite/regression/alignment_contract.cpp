...
static void construct_alignment_succeeds() {
    Stack<> stack(128, 32);
...
static void default_alignment_bound() {
    Stack<> stack(64);
...
static void moved_from_default_alloc() {
    Stack<> source(64);
...
static void run_tests() {
    RUN(construct_alignment_succeeds);
    RUN(default_alignment_bound);
    RUN(moved_from_default_alloc);
}
