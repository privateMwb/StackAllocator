...
static void concurrent_reads_see_consistent_snapshot() {
    Stack<> stack(128);
...
// fixed, live pointer.
static void concurrent_owns_checks_are_consistent() {
    Stack<> stack(64);
...
static void concurrent_stats_reads_are_consistent() {
    Stack<true> stack(64);
...
static void run_tests() {
    RUN(concurrent_reads_see_consistent_snapshot);
    RUN(concurrent_owns_checks_are_consistent);
    RUN(concurrent_stats_reads_are_consistent);
}
