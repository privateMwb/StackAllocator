...
static void independent_stacks_do_not_see_each_others_allocations() {
...
static void scope_rollback_is_isolated_per_thread() {
    constexpr int kThreads = 4;
...
static void many_thread_local_stacks_match_serial_result() {
...
static void run_tests() {
    RUN(independent_stacks_do_not_see_each_others_allocations);
    RUN(scope_rollback_is_isolated_per_thread);
    RUN(many_thread_local_stacks_match_serial_result);
}
